from clase import Resurse, Caracter, Satean, Cavaler, Infanterist, Erou, Centru, Cazarma, Staul, Cladire
...
class Joc:
    ...
    def creeaza_cavaler(self, id_cavaler):
        ...
        if self.resurse_initiale.verif(cavaler.cost) and Staul.nr_staul > 0:
